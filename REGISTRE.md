...
- **Routage automatique** — **non** — apport modeste sur le seul artefact éprouvé, quatrième condition d'admission non satisfaite (voir `BASELINE.md`). Reste convocable à la main.
