...
À quelles conditions un outil entre au dépôt. Le dépôt existe parce qu'une skill installée apporte un cadre que rien ne conteste ; il s'est donné une règle après avoir dû retirer une skill arrivée par effet de bord, puis a laissé passer un second cas parce que cette règle nommait un répertoire. Cette capacité déplace le critère : ce qui déclenche la décision est **ce que l'outil prescrit sur la façon de travailler**, non l'endroit où ses fichiers se posent. Elle dit aussi ce que la trace doit contenir — un refus se consigne comme une admission — et ce que le dispositif de convocation a le droit de lire.
