...
Le chemin qu'un changement emprunte jusqu'à `main`, et ce qui le contraint. Le dépôt a poussé quarante commits en direct avant de trancher, et trois documents renvoyaient à une décision qui n'existait pas. Cette capacité dit quelles branches existent et pour combien de temps, comment elles se nomment, comment elles rejoignent `main`, ce qui a le droit d'y être poussé en direct, et ce qu'un contrôle qui bloque doit à la personne qu'il bloque.
